package io.quarkiverse.langchain4j.custom.anthropicp.deployment;
...
import io.quarkiverse.langchain4j.custom.anthropicp.runtime.AnthropicRecorder;
...
public class AnthropicProcessor {
    private static final String FEATURE = "langchain4j-anthropicp";
    private static final String PROVIDER = "anthropicp";
